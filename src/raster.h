...
public:
        ...
        virtual void                    frame_buf_set_background(buffer_location loc, float r, float g, float b, float a) = 0;
        ...
        virtual void                    attri_buf_writef32(buffer_location loc, float* data, unsigned size, unsigned grp_size, bool onchip) = 0;
        ...
        virtual void                    index_buf_write(buffer_location loc, unsigned* data, unsigned size, bool onchip) = 0;
        ...
        virtual void                    program_assign_uniform(program_location loc, char const* var_name, float* data, char const* type) = 0;
        virtual void                    program_assign_input(program_location loc, char const* input, buffer_location buf) = 0;

        virtual void                    draw_indexed_triangles(buffer_location frame,
                                                               program_location prog,
                                                               buffer_location index_buf, unsigned offset, unsigned length) = 0;
        virtual void                    draw_triangles(buffer_location frame, program_location prog, unsigned offset, unsigned length) = 0;
        virtual void                    draw_points(buffer_location frame, program_location prog, unsigned offset, unsigned length) = 0;
};
