...
void test::test_tensor::run() const
{
    ...
    // Test matrix.
    e8util::mat33 m = {1, 3, 2, 2, 2, 1, 3, 1, 2};
    e8util::mat31 m2 = {1, 4, 7};
    ...
    e8util::mat33 k = {-3, -1, 3, 2, 0, -4, -5, -2, 1};

    assert(k.adjugate() == e8util::mat33({-8, -5, 4, 18, 12, -6, -4, -1, 2}));

    e8util::mat33 k2 = {-2, -1, 2, 2, 1, 0, -3, 3, -1};
