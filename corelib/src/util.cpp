...
val_diff(std::map<std::string, T> const& a,
...
e8util::flex_config
e8util::flex_config::operator-(flex_config const& other) const
{
        ...
        for (auto const& this_enum_vals_configs : enum_val_configs) {
                ...
                if (it_other == other.enum_val_configs.end()) {
                        ...
                        flex_config const& other_config =
                                        this_enum_vals_configs.second - it_other->second;
