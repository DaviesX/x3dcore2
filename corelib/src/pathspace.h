...
public:
    ...
    virtual std::vector<if_light const *> get_relevant_lights(
        e8util::frustum const &frustum) const = 0;
...
private:
    ...
    struct flattened_node
    {
        ...
        flattened_node(e8util::aabb const &bound,
    ...
    std::vector<bucket> sah_buckets(std::vector<primitive_details> const &prims,
                                    unsigned start,
                                    unsigned end,
                                    unsigned axis,
