...
e8::basic_light_sources::light_cdf::light_cdf(if_light const* light,
                                              float cum_power):
        light(light),
        cum_power(cum_power)
{
...
e8::if_light const*
e8::basic_light_sources::sample_light(e8util::rng& rng, float& pdf) const
{
