...
e8::if_frame::surface &e8::if_frame::front()
{
    return m_surface[!m_spin];
}

e8::if_frame::surface &e8::if_frame::back()
{
    return m_surface[m_spin];
}

e8::if_frame::surface const &e8::if_frame::front() const
{
    return m_surface[!m_spin];
}

e8::if_frame::surface const &e8::if_frame::back() const
{
    return m_surface[m_spin];
}
...
unsigned e8::if_frame::width() const
{
    return back().w;
}

unsigned e8::if_frame::height() const
{
    return back().h;
}
...
void e8::ram_ogl_frame::commit()
{
    swap();
}

void e8::ram_ogl_frame::initializeGL()
{
