...
std::string e8::if_material::name() const
{
    return m_name;
}
...
e8util::vec3 e8::mat_fail_safe::eval(e8util::vec3 const & /* n */,
                                     e8util::vec3 const & /* o */,
...
e8util::vec3 e8::mat_fail_safe::sample(e8util::rng &rng,
                                       e8util::vec3 const &n,
                                       e8util::vec3 const & /* o */,
                                       float &pdf) const
{
...
e8util::vec3 e8::oren_nayar::eval(e8util::vec3 const &n,
                                  e8util::vec3 const &o,
                                  e8util::vec3 const &i) const
{
...
e8util::vec3 e8::oren_nayar::sample(e8util::rng &rng,
                                    e8util::vec3 const &n,
                                    e8util::vec3 const & /* o */,
                                    float &pdf) const
{
...
float e8::cook_torr::ggx_shadow(e8util::vec3 const &i,
                                e8util::vec3 const &o,
...
e8util::vec3 e8::cook_torr::eval(e8util::vec3 const &n,
                                 e8util::vec3 const &o,
                                 e8util::vec3 const &i) const
{
...
e8util::vec3 e8::cook_torr::sample(e8util::rng &rng,
                                   e8util::vec3 const &n,
                                   e8util::vec3 const &o,
                                   float &pdf) const
{
