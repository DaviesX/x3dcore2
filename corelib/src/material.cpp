...
e8util::color3 e8::mat_fail_safe::eval(e8util::vec2 const & /*uv*/, e8util::vec3 const & /*n*/,
                                       e8util::vec3 const & /*o*/,
...
e8util::color3 e8::mat_mixture::eval(e8util::vec2 const &uv, e8util::vec3 const &n,
...
e8::oren_nayar::oren_nayar(std::string const &name, e8util::color3 const &albedo, float roughness,
                           std::shared_ptr<texture_map<e8util::color3>> const &albedo_map,
...
e8util::color3 e8::oren_nayar::albedo(e8util::vec2 const &uv) const {
...
e8util::color3 e8::oren_nayar::eval(e8util::vec2 const &uv, e8util::vec3 const &n,
                                    e8util::vec3 const &o, e8util::vec3 const &i) const {
...
e8::cook_torr::cook_torr(std::string const &name, e8util::color3 const &albedo, float roughness,
...
e8util::color3 e8::cook_torr::albedo(e8util::vec2 const &uv) const {
...
e8util::color3 e8::cook_torr::eval(e8util::vec2 const &uv, e8util::vec3 const &n,
                                   e8util::vec3 const &o, e8util::vec3 const &i) const {
